    ...
    items: [
      {
        ...
        p: "نقدّم خدمات التصميم المعماري الكاملة للمشاريع السكنية — من الأفكار الأولية إلى المخططات التنفيذية. تجمع منهجيتنا بين التسليم الرقمي بتقنية BIM والخبرة العميقة باللوائح المحلية، لضمان تصاميم طموحة وقابلة للتنفيذ",
        items: [
          {
