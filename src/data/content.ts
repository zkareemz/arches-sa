...
const ar: SiteContent = {
  seo: {
    title: "أقواس | شركة هندسية استشارية في الرياض",
    description:
      "أقواس مكتب هندسي في الرياض يقدم خدمات الاستشارات الهندسية للتصميم وادارة المشروع والإشراف الهندسي، والتصميم الداخلي والتأثيث. تواصل معنا لمناقشة مشروعك.",
  ...
  hero: {
    ...
    p: "شركة هندسية متعددة التخصصات، نقدّم خدمات متكاملة في التصميم المعماري وإدارة المشروع والتصميم الداخلي — تحت سقفٍ واحد",
    cta: "لنتحدث",
    scroll: "اكتشف المزيد",
    image: IMG.hero,
  },
    ...
    points: [
      {
        ...
        desc: "نقدّم خدمات متكاملة في التصميم وادارة المشروع تحت سقفٍ واحد منذ عام 2015",
      },
      {
